...
public class SelAddComponents implements Command {

  private ArrayList<Component> cs;
  private SelectionModel sm;
  private ParamsManager pm;
  private ControlRect controlRect;

  public SelAddComponents(Layer layer) {
    this(layer.components);
  }

  public SelAddComponents(ArrayList<Component> cs) {
    this.cs = cs;
